	...
	exports.dialog = function(options) {
		...
		if (options.size) {
			...
			if (options.fullBootstrapVersion.substring(0, 3) < '3.1') {
				console.warn('"size" requires Bootstrap 3.1.0 or higher. You appear to be using ' + options.fullBootstrapVersion +
		...
		if (options.centerVertical) {
			...
			if (options.fullBootstrapVersion < '4.0.0') {
				console.warn('"centerVertical" requires Bootstrap 4.0.0-beta.3 or higher. You appear to be using ' + options.fullBootstrapVersion +
					'. Please upgrade to use this option.')
			}
			...
			if (type === 'date') {
				...
				if (/([01][0-9]|2[0-3]):[0-5][0-9]?:[0-5][0-9]/.test(value)) {
					if (compareValue === undefined || options.max > options.min) {
						...
						throw new Error('"max" must be greater than "min". See https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#attr-' + name +
				...
				if (!isNaN(value)) {
					...
					throw new Error('"' + name + '" must be a valid number. See https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#attr-' + name +
						' for more information.')
				}
			}
		}
