...
@section('content')
    <div class="m-content">
        <div class="m-portlet">
            <form id="role_form" class="m-form m-form--state" method="post" action="{{ route('roles.update', $role) }}">
                <div class="m-portlet__body">
                    ...
                    <div class="form-group m-form__group row">
                        <div class="col-lg-12">
                            @include('admin.roles._permission_table', ['groups' => $groups, 'disabled' => false ])
                        </div>
                    </div>
                </div>
                <div class="m-portlet__foot m-portlet__foot--fit m-portlet__foot-no-border">
                    <div class="m-form__actions m-form__actions--right pl-0">
