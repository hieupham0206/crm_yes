 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Commission whereAmount($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Commission whereContractNo($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Commission whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Commission whereEffectiveTime($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Commission whereEndTime($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Commission whereEventDataId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Commission whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Commission whereLimit($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Commission whereMemberId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Commission whereMembership($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Commission whereNetAmount($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Commission whereNumOfPayment($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Commission whereRoomType($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Commission whereSignedDate($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Commission whereStartDate($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Commission whereState($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Commission whereTotalPayment($value)
